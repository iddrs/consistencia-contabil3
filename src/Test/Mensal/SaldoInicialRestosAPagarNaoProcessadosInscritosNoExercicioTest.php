...
class SaldoInicialRestosAPagarNaoProcessadosInscritosNoExercicioTest extends TestBase {
    
    public function __construct(int $remessa, array $entidades) {
        $testName = 'Restos a Pagar Não Processados inscritos no exercício: saldo inicial';
    ...
    public function run(): void {
        ...
        $esquerdo[] = sprintf($sql, $this->remessa, $this->entidadesIn, '63171%');
