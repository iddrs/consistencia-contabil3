...
$tester
        ...
        ->addTest(new \App\Test\Mensal\PrevisaoInicialDeducaoFundebTest($remessa, $entidades))
        ...
        ->addTest(new \App\Test\Mensal\DeducaoFundebRealizadaTest($remessa, $entidades))
...
//        ->addTest(new \App\Test\Mensal\SaldoInvertidoTest($remessa, $entidades))
        ...
        ->addTest(new \App\Test\Mensal\ConsorcioModalidade93CredorTest($remessa, $entidades))
        ->addTest(new \App\Test\Mensal\ConsorcioModalidade71CredorTest($remessa, $entidades))
        ->addTest(new \App\Test\Mensal\ConsorcioModalidadeCredorTest($remessa, $entidades))
        ->addTest(new \App\Test\Mensal\CofronRateioControleTest($remessa, $entidades))
        ->addTest(new \App\Test\Mensal\CisaRateioControleTest($remessa, $entidades))
